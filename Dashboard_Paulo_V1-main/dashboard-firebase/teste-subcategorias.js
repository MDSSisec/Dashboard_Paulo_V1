// Script de teste para validar subcategorias
const axios = require('axios');

async function testarSubcategorias() {
  try {
    console.log('🧪 Testando subcategorias...');
    
    // Teste 1: Múltiplas subcategorias em uma categoria
    console.log('\n📋 Teste 1: Múltiplas faixas etárias (18-24, 25-29, 30-39)');
    ...
    console.log('\n🎯 Resumo dos testes de subcategorias:');
    ...
    console.error('❌ Erro ao testar subcategorias:', error.message);
    if (error.response) {
